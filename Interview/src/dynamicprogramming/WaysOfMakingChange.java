...
public class WaysOfMakingChange {
	class AmountDenom {
		...
		// we need to override hashCode and equals method for user defined objects when
		// these objects are used as keys
		@Override
		public int hashCode() {
	...
	public int countNumberOfWays(int amount, int denom, HashMap<AmountDenom, Integer> numberOfWays) {
		...
		while ((numberOfCoins * denom) <= amount) {
			...
			// check if we have already computed the number of ways for this amount and
			// denom set
